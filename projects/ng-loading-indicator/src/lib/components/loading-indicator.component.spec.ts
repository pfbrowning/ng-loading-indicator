...
describe('LoadingIndicatorComponent', () => {
  ...
  beforeEach(() => {
    ...
    // Get a handle to the modal header so that we can query the bound text
    modalHeader = fixture.debugElement.query(By.css('h1[header]')).nativeElement;
  ...
  it('should properly show and hide the loading indicator', () => {
    ...
    expect(modalHeader.textContent).toBe("Load Started");
